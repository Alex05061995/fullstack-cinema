...
const ActorService = {
    ...
    async getBySlug (slug) {
        return api_interceptors__WEBPACK_IMPORTED_MODULE_0__/* .axiosClassic.get */ .vV.get((0,_config_api_config__WEBPACK_IMPORTED_MODULE_1__/* .getActorssUrl */ .bc)(`/by-slug/${slug}`));
    },
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_ui_CatalogMovies_Catalog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7914);
/* harmony import */ var _services_movie_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6962);
/* harmony import */ var _services_actor_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3908);
/* harmony import */ var _404__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5838);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_ui_CatalogMovies_Catalog__WEBPACK_IMPORTED_MODULE_1__, _services_movie_service__WEBPACK_IMPORTED_MODULE_2__, _services_actor_service__WEBPACK_IMPORTED_MODULE_3__]);
([_components_ui_CatalogMovies_Catalog__WEBPACK_IMPORTED_MODULE_1__, _services_movie_service__WEBPACK_IMPORTED_MODULE_2__, _services_actor_service__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const ActorPage = ({ movies , actor  })=>{
    return actor ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_CatalogMovies_Catalog__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
        movies: movies || [],
        title: actor.name
...
const getStaticProps = async (context)=>{
    try {
        const { data: actor  } = await _services_actor_service__WEBPACK_IMPORTED_MODULE_3__/* .ActorService.getBySlug */ .V.getBySlug(String(context.params?.slug));
        const { data: movies  } = await _services_movie_service__WEBPACK_IMPORTED_MODULE_2__/* .MovieService.getByActor */ .u.getByActor(actor._id);
        return {
            props: {
                movies,
                actor
...
var __webpack_exports__ = __webpack_require__.X(0, [664,443,675,779,494,583,962,248,914], () => (__webpack_exec__(9141)));
